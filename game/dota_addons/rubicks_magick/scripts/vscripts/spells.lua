...
function Spells:Init()
	...
	CustomGameEventManager:RegisterListener("me_ld", Dynamic_Wrap(Spells, "OnDirectedCastKeyDown"))
	CustomGameEventManager:RegisterListener("me_lu", Dynamic_Wrap(Spells, "OnDirectedCastKeyUp"))
	CustomGameEventManager:RegisterListener("me_md", Dynamic_Wrap(Spells, "OnSelfCastKeyDown"))
	CustomGameEventManager:RegisterListener("me_mu", Dynamic_Wrap(Spells, "OnSelfCastKeyUp"))
