...
function IceSpikes:Precache(context)
	...
	PrecacheResource("soundfile", "sounds/weapons/hero/ancient_apparition/attack1.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/ancient_apparition/attack2.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/ancient_apparition/attack3.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/ancient_apparition/attack4.vsnd", context)	
	PrecacheResource("soundfile", "sounds/weapons/hero/windrunner/powershot_damage01.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/windrunner/powershot_damage02.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/windrunner/powershot_damage03.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/windrunner/powershot_damage04.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/windrunner/powershot_damage05.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/ancient_apparition/cold_feet.vsnd", context)
	PrecacheResource("soundfile", "sounds/physics/footsteps/common/waterstep_01.vsnd", context)
	PrecacheResource("soundfile", "sounds/physics/footsteps/common/waterstep_02.vsnd", context)
	PrecacheResource("soundfile", "sounds/physics/footsteps/common/waterstep_03.vsnd", context)
	PrecacheResource("soundfile", "sounds/physics/footsteps/common/waterstep_04.vsnd", context)
	PrecacheResource("soundfile", "sounds/physics/footsteps/common/waterstep_05.vsnd", context)
	PrecacheResource("soundfile", "sounds/physics/footsteps/common/waterstep_06.vsnd", context)
	PrecacheResource("soundfile", "sounds/physics/footsteps/common/waterstep_07.vsnd", context)
	...
	PrecacheResource("soundfile", "sounds/weapons/hero/witch_doctor/maledict_tick.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/ancient_apparition/cold_feet_tick.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/ancient_apparition/cold_feet_tick2.vsnd", context)
	PrecacheResource("soundfile", "sounds/weapons/hero/ancient_apparition/cold_feet_tick3.vsnd", context)
end
