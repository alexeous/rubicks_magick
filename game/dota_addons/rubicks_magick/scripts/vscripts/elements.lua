...
PSEUDO_ELEMENT_STEAM = 9
PSEUDO_ELEMENT_ICE = 10

ALL_ELEMENTS = { 
	ELEMENT_SHIELD, ELEMENT_EARTH, ELEMENT_LIGHTNING, ELEMENT_LIFE, 
	ELEMENT_DEATH, ELEMENT_WATER, ELEMENT_FIRE, ELEMENT_COLD 
}

ALL_ELEMENTS_INCLUDING_PSEUDO = {
	ELEMENT_SHIELD, ELEMENT_EARTH, ELEMENT_LIGHTNING, ELEMENT_LIFE, 
	ELEMENT_DEATH, ELEMENT_WATER, ELEMENT_FIRE, ELEMENT_COLD,
	PSEUDO_ELEMENT_STEAM, PSEUDO_ELEMENT_ICE
}
